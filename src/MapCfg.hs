...
readLevelModels :: BasicHashTable String Model -> LevelModel -> IO ()
...
getModel :: BasicHashTable String Model -> String -> String -> IO ()
...
getWeaponModel :: BasicHashTable String Model -> String -> IO ()
